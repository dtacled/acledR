...
df1 %>%
  ...
  kbl(caption = paste0("Table of event counts and fatalities by sub event type since ", params$start_date, " until ", max(params$data$event_date)),align = "c",col.names = c("","Sub Event Types", "Number of Events", "Number of Fatalities"))%>%
   kable_styling(full_width =T)%>%
  pack_rows("Violence Targeting Civilians",min_vtc,max_vtc)%>%
  pack_rows("Organized Political Violence",min_opv,max_opv) 
