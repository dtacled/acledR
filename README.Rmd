...
To access ACLED data, please register an account at [myACLED](https://acleddata.com/myacled). You can find detailed instructions about the ACLED API [here](https://acleddata.com/api-documentation/). 
