...
Not to be included yet:
 - With rachel we discussed how much of document we wanted related to methodology. As it stands, this is a very heavy methodological piece, which perhaps would be better of to be re-directed to the actual codebook. 
...
ACLED collects and codes reported information on three general types of events: political violence, demonstrations, and select non-violent, politically important events. Under the general categories, there are 6 __event types__ and 25 __sub-event types__. 
...
In some cases, ACLED also records events which are not necesarrily politically violent events. 
