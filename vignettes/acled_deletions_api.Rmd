...
load(file="~/ACLED/Data Literacy/R 4 Finance/R 4 finance project/argen_dummy_acled_file.rda") # Here is our personal ACLED dataset
...
As we can see 191 events have been removed since the last time I uploaded my data (1st August 2022, around 1 month and a half at the time writing). Now that we know there are deleted events, lets check if any of these are in my dataset.
