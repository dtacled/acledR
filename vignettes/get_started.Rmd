...
```{r acled_categories()}
arg_cats <- filter_event_types(argentinian_data, # data
...
The third of these functions, `calculate_actor_index()` allows users to find how are the actor interactions in the dataset, more specifically,  how dissipated or concentrated a given dataset is. This function utilizes two types of indexes to assess this, either the Inverse Simpson Index or the Herfindahl-Hirschman Index. 
