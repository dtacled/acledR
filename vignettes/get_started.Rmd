...
In some cases you may prefer to fit the data into a different format than the default wide-form output that its received from the API call. For these cases we offer users two functions: `acled_filter_actors()` and `acled_transform_longer`. 
