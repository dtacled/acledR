...
In this vignette you will receive a brief explanation of how to use ACLED’s R package. Besides this initial walkthrough, you can find more detailed explanations and examples under the 'Utilizing acledR' tab. Alternatively, for information relating to ACLED’s methodology, please visit [ACLED's Knowledge Base](https://acleddata.com/knowledge-base/). 
...
```{r}
argentinian_data <- acled_api(country = "Argentina", start_date="2022-01-01", end_date = "2022-12-31", prompt = F, inter_numeric = TRUE)
```
