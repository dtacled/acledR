...
ACLED API access requires an API key for authentication. To register for API access, please visit ACLED's Access Portal [here](developer.acleddata.com). You can also find a detailed guide on creating your account and obtaining your API key in [ACLED's Access Guide](https://acleddata.com/acleddatanew//wp-content/uploads/2021/11/ACLED_Access-Guide_October-2020.pdf).
